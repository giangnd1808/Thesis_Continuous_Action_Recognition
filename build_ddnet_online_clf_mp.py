...
class Config():
    def __init__(self):
        ...
        self.clc_num = 20 # the number of class, (= 8 if using subsets)
        self.feat_d = 528
        self.filters = 64
        self.nd = 60

#Define data processing functions
def zoom(p,target_l=32,joints_num=33,joints_dim=3):
    l = p.shape[0]
...
def build_FM(frame_l=32,joint_n=33,joint_d=3,feat_d=528,filters=64, nd=60):
    drop_rate = 0.1
